...
export const games: Game[] = [
  ...
  },
  {
    id: 'pong',
    name: 'Pong',
    description: 'Classic paddle and ball. Bounce the ball past your opponent\'s paddle to score.',
    category: 'arcade',
    path: '/games/pong',
    icon: 'Square',
    keywords: ['pong', 'paddle', 'ball', 'arcade', 'retro'],
  },
  {
    id: 'fifteen-puzzle',
    name: 'Fifteen Puzzle',
    description: 'Slide the tiles to put numbers 1–15 in order. One empty space—slide adjacent tiles.',
    category: 'puzzle',
    path: '/games/fifteen-puzzle',
    icon: 'LayoutGrid',
    keywords: ['fifteen puzzle', 'sliding puzzle', '15', 'tiles', 'puzzle'],
  },
  {
    id: 'word-scramble',
    name: 'Word Scramble',
    description: 'Unscramble the letters and type the word. Check your answer and try the next one.',
    category: 'word',
    path: '/games/word-scramble',
    icon: 'Shuffle',
    keywords: ['word scramble', 'anagram', 'unscramble', 'word', 'letters'],
  },
  {
    id: 'sudoku',
    name: 'Sudoku',
    description: 'Fill the 9×9 grid so each row, column, and 3×3 box has digits 1–9. Classic number logic puzzle.',
    category: 'puzzle',
    path: '/games/sudoku',
    icon: 'Hash',
    keywords: ['sudoku', 'number', 'logic', 'puzzle', 'grid'],
  },
  {
    id: 'minesweeper',
    name: 'Minesweeper',
    description: 'Reveal cells without hitting mines. Numbers show how many mines are in adjacent cells.',
    category: 'puzzle',
    path: '/games/minesweeper',
    icon: 'Bomb',
    keywords: ['minesweeper', 'mines', 'grid', 'puzzle', 'classic'],
  },
  {
    id: 'solitaire',
    name: 'Solitaire',
    description: 'Classic Klondike card game. Build down by alternating colors, build foundations up by suit.',
    category: 'puzzle',
    path: '/games/solitaire',
    icon: 'Library',
    keywords: ['solitaire', 'klondike', 'cards', 'patience', 'puzzle'],
  },
  {
    id: 'word-search',
    name: 'Word Search',
    description: 'Find hidden words in the grid. Words run in any direction—horizontal, vertical, or diagonal.',
    category: 'word',
    path: '/games/word-search',
    icon: 'Search',
    keywords: ['word search', 'word find', 'word search puzzle', 'letters', 'word'],
  },
  {
    id: 'typing-speed',
    name: 'Typing Speed Test',
    description: 'Type the passage as fast as you can. See your words per minute and accuracy when you finish.',
    category: 'word',
    path: '/games/typing-speed',
    icon: 'Keyboard',
    keywords: ['typing test', 'wpm', 'typing speed', 'keyboard', 'accuracy'],
  },
];
